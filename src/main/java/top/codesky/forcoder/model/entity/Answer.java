...
public class Answer {
     ...
     * @mbg.generated 2019-05-05 11:28:05
     */
    public Answer(Long id, int commentCount, int voteupCount, boolean anonymously, Long authorId, Long questionId, Date gmtCreated, Date gmtModified) {
        this.id = id;
     ...
     * @mbg.generated 2019-05-05 11:28:05
     */
    public Answer(Long id, int commentCount, int voteupCount, boolean anonymously, Long authorId, Long questionId, Date gmtCreated, Date gmtModified, String content, String excerpt) {
        this.id = id;
        this.commentCount = commentCount;
        this.voteupCount = voteupCount;
        this.anonymously = anonymously;
     ...
     *
     * @param gmtCreated the value for answer.gmt_create
     *
     * @mbg.generated 2019-05-05 11:28:05
     */
