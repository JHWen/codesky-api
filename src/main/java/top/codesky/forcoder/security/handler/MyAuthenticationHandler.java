...
public class MyAuthenticationHandler implements AuthenticationSuccessHandler, AuthenticationFailureHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Authentication authentication) throws IOException, ServletException {
        ...
        BaseResponseVo responseVo = new BaseResponseVo(HttpStatus.OK.value(), "login success");
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        ...
        BaseResponseVo responseVo = new BaseResponseVo(HttpStatus.UNAUTHORIZED.value(), exception.getMessage());
